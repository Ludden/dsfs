...
while True:
    ...
    i += 1                                  # count iterations needed for convergence
print('converged to:', v, 'after', i, 'iterations.')


def safe(f):
    """return a new function that's the same as f except when f produces an error"""
